                     ...
                     <div class="page-title-heading">
                        <div> MENGELOLA UJIAN
                            <div class="page-title-subheading">
                              Tambahkan Pertanyaan Untuk <?php echo $selExamRow['ex_title']; ?>
                            </div>
                        </div>
                    </div>
                </div>
                           ...
                           <form method="post" id="updateExamFrm">
                              ...
                              <div class="form-group">
                                ...
                                <select class="form-control" name="examLimit" required="">
                                  <option value="<?php echo $selExamRow['ex_time_limit']; ?>"><?php echo $selExamRow['ex_time_limit']; ?> Menit</option>
                          ...
                          <div class="card-header"><i class="header-icon lnr-license icon-gradient bg-plum-plate"> </i>Pertanyaan Ujian
                            <span class="badge badge-pill badge-primary ml-2">
                             ...
                             <div class="btn-actions-pane-right">
                                <button class="btn btn-sm btn-primary " data-toggle="modal" data-target="#modalForAddQuestion">Tambahkan</button>
                              </div>
                          </div>
                          <div class="card-body" >
                            ...
                            <?php 
                               ...
                               { ?>
                                  <h4 class="text-primary">Tidak Ada Pertanyaan</h4>
                                 <?php
                               }
                             ?>
                               </div>
