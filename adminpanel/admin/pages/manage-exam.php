                    ...
                    <div class="table-responsive">
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                            ...
                            <tr>
                                ...
                                <th class="text-left ">Batas Tampilan</th>  
                            ...
                            <tbody>
                              <?php 
                                    ...
                                    while ($selExamRow = $selExam->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                             <a href="manage-exam.php?id=<?php echo $selExamRow['ex_id']; ?>" type="button" class="btn btn-primary btn-sm">Kelola</a>
                                             <button type="button" id="deleteExam" data-id='<?php echo $selExamRow['ex_id']; ?>'  class="btn btn-danger btn-sm">Hapus</button>
                                            </td>
                                        </tr>
                                ...
                                { ?>
                                    <tr>
                                      <td colspan="5">
                                        <h3 class="p-3">Tidak Ditemukan Ujian</h3>
                                      </td>
                                    </tr>
                                <?php }
                               ?>
